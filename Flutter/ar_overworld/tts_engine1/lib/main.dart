...
class _MyAppState extends State<MyApp> {
  ...
  String _newVoiceText="Hello this is Nevin. This is the place where the Data from each monument should be read out using FIreBase"; //the statements from the firebase string should be downloaded here
    ...
    if (isAndroid) {
      return Container(
          ...
          child:
            ...
            _buildButtonRow(
                Colors.blue, Colors.redAccent, Icons.stop, 'PAUSE', _pause),
          ]));
    } else {
      return Container(
          padding: EdgeInsets.only(top: 50.0),
